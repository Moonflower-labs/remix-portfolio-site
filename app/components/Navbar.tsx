    ...
    <div className="navbar bg-primary/90 backdrop-blur text-primary-content sticky top-0 z-[100] shadow-lg">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content bg-primary/90 text-primary-content mt-3 z-[1] p-2 shadow rounded-box w-52">
            ...
            <li><Link to={"projects"} onClick={handleDropdown}>Projects</Link></li>
